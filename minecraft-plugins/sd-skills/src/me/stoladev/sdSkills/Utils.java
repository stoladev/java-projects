...
public class Utils {
  ...
  public static String sdLabelAdmin = color("&8[sdSkills - Admin]");
  public static String sdLabel = color("&8[sdSkills]");
  ...
  public static void error(String... messages) {
    for (String message : messages) logger.severe(message);
  }
}
